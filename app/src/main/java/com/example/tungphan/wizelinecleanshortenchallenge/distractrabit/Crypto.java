...
//    }
    ...
    @SuppressLint("NewApi")
    public static KeyPair generateRsaPairWithGenerator(Context ctx, String alias)
            throws Exception {
        ...
        keyPairGenerator.initialize(
                new KeyGenParameterSpec.Builder(
                        ...
                        .setKeySize(256)
                        .setCertificateSubject(new X500Principal(String.format("CN=%s, OU=%s", alias,
                                ctx.getPackageName())))
    ...
    @SuppressLint("NewApi")
    public static KeyPair generateEcPairWithGenerator(Context ctx, String alias)
            throws Exception {
        Calendar notBefore = Calendar.getInstance();
        Calendar notAfter = Calendar.getInstance();
        notAfter.add(Calendar.YEAR, 1);
